...
class CollisionApp:
    ...
    def show_crop_interface(self, frame=None):
    ...
    def display_first_frame(self, frame=None):
        ...
        print('frame count: ', self.collision.frame_count)
    ...
    def display_clipped_frames(self):
        ...
        self.slider.configure(to=self.collision.frame_count - 1, command=lambda event: update_display(int(self.slider.get())))
        update_display(0)
